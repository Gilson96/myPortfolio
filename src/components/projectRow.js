...
const ProjectRow = ({ name, logo, image, live, github, description, screenshot, title, inlineStyle }) => {
  ...
  return (
    <Fade delay={1e3}>
      ...
      >
        <div className={`bg-[url(${logo})] bg-center bg-[length:240px_100px] bg-no-repeat h-20 w-60 rounded-lg shadow-lg`}/>
